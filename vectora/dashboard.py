...
def build_html(con, date_str: str | None = None) -> str:
    ...
    return _TEMPLATE.format(
        ...
        track_start=_TRACK_RECORD_START,
...
<div class="paper">
  ...
  model on public data. The live track record (hit rates, realized
  calibration) begins <b>{track_start}</b> once predictions mature.
